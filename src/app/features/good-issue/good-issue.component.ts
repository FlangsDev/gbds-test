...
export class GoodIssueComponent {
  historyList = [
    { id: 1, date: '08-03-2026', batchNumber: '000001', partNumber: 'PN-1001A', description: 'DOCUMENT DESC/OXYGEN BOTTLE', qty: 10, unit: 'SET', shippedTo: 'PT. Garuda MRO', docNo: '0001/GMF/20260308' },
    { id: 2, date: '10-03-2026', batchNumber: '000002', partNumber: 'PN-1002B', description: 'EASTMAN TURBO OIL 2197', qty: 5, unit: 'LTR', shippedTo: 'PT. Lion Air Technik', docNo: '0002/GMF/20260310' },
  ];

  globalSearch = '';
  colSearch: any = {
    date: '', batchNumber: '', partNumber: '', description: '', qty: '', unit: ''
  };
